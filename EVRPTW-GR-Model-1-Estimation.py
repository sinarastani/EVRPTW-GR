...
EVRPTW-GR Model 1 - Estimation 
  - In the optimization model, efficiency factors are assumed to be 1
    (mu = mu_train = regenerating = 1).
  - After solving, the obtained routes are mapped to the original problem
    by re-computing the objective with the correct efficiency factors.
...
# filename = "c104_50_21_L.txt"
# filename = "c104_50_21_NL.txt"
# filename = "c104_50_21_VG.txt"

# filename = "c108_50_21_L.txt"
# filename = "c108_50_21_NL.txt"
# filename = "c108_50_21_VG.txt"

# filename = "r102_50_21_L.txt"
# filename = "r102_50_21_NL.txt"
# filename = "r102_50_21_VG.txt"

# filename = "r104_50_21_L.txt"
# filename = "r104_50_21_NL.txt"
# filename = "r104_50_21_VG.txt"

# filename = "r107_50_21_L.txt"
# filename = "r107_50_21_NL.txt"
# filename = "r107_50_21_VG.txt"

# filename = "r110_50_21_L.txt"
# filename = "r110_50_21_NL.txt"
# filename = "r110_50_21_VG.txt"

# filename = "rc101_50_21_L.txt"
# filename = "rc101_50_21_NL.txt"
# filename = "rc101_50_21_VG.txt"

# filename = "rc103_50_21_L.txt"
# filename = "rc103_50_21_NL.txt"
# filename = "rc103_50_21_VG.txt"

# filename = "rc104_50_21_L.txt"
# filename = "rc104_50_21_NL.txt"
# filename = "rc104_50_21_VG.txt"

# filename = "rc106_50_21_L.txt"
# filename = "rc106_50_21_NL.txt"
# filename = "rc106_50_21_VG.txt"
...
# =============================================================================
# READ INSTANCE DATA (NEW _L/_NL/_VG WITH ALTITUDE IN SAME FILE)
# =============================================================================
...
# =============================================================================
# ENERGY PARAMETERS (MODEL PHASE: EFFICIENCIES SET TO 1)
# =============================================================================
...
print("Average angle (deg): ", np.average(np.abs(angle)))
print("Average gradient (%): ", 100 * np.average(np.abs(gradient_list)))
print("---------------------\n")

# base consumption with model efficiencies
p_tract_base = (
...
# =============================================================================
# CUTS: ENERGY MIN/MAX ON ARCS (using model efficiencies)
# =============================================================================

def min_energy_consumption(s, i):
    energy_consump_list = []
    for load_local in [0, sum(demand)]:
        p_tract_si = (
            (weight + load_local) * acceleration
            + (weight + load_local) * gg * np.sin(np.deg2rad(angle[s, i]))
            + 0.5 * cd * ro * a * v_s * v_s
            + (weight + load_local) * gg * cr * np.cos(np.deg2rad(angle[s, i]))
        ) * v_s / 1000.0
        if p_tract_si >= 0:
...
# =============================================================================
#                             OPTIMIZATION MODEL (MILP1)
# =============================================================================

start_time = time.time()
evrp = Model("EVRP_MILP1")
...
# energy expressions with hh (using model consump_base, mu=1)
evrp.addConstrs(
    (hh[i, j] >=
...
# Objective using estimated consumption factors (hh)
evrp.setObjective(
...
if write_in_text == 1:
    ...
    print("objVal (model, estimated): ", objVal)
    print("num_veh: ", num_v)
    print("status", evrp.status)

# =============================================================================
# ROUTE RECONSTRUCTION (customers first, then insert stations) – SAME AS MILP2
# =============================================================================
...
# =============================================================================
# POST-PROCESSING WITH REAL EFFICIENCY FACTORS (MAPPING TO ORIGINAL PROBLEM)
# =============================================================================
...
if not error_status and len(vehicles_copy) > 0:
    ...
    # recompute base consumption with real efficiencies
    p_tract_base = (
        (weight + load) * acceleration
        + (weight + load) * gg * np.sin(np.deg2rad(degree))
        + 0.5 * cd * ro * a * v_s * v_s
    ...
    print()
    print("---------------------------------")
    print("OFV (post-processed, real efficiencies) = ", ofvv)
